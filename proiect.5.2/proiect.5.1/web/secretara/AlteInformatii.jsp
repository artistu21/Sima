    ...
    <form action="DatePersonale.jsp" method="post">
       ...
       <form action="DatePersonale.jsp" method="POST">
                ...
                <tbody>
                    <tr>
                        <td>Stare civila:</td>
                        <td><input type="text" name="stare civila "></td>
                    </tr>
                    <tr>
                        <td>Nationalitate:</td>
                    ...
                    <tr>
                        <td>Cetatenie:</td>
                        <td><input type="text" name="cetatenie"></td>
                    </tr>
                    <tr>
                        <td>Alta cetatenie :</td>
                        <td><input type="text" name="alta cetatenie"></td>
                    </tr>
                    <tr>
                        <td>Cetatenie anterioara:</td>
                        <td><input type="date" name="cetatenie anterioara"></td>
                    </tr>
                    <tr>
                        <td>Stare sociaa speciala :</td>
                        <td><input type="text" name="stare sociala speciala"></td>
                    </tr>
                </tbody>
            </table>
